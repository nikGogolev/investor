...
export const addTicker = async (ticker, dateFrom, dateTill, quantity, currency, prevData, isAutoComplete, isManual, manualCourse, manualInfo, bondNominal, couponOrDividend = 0) => {
    let friday = +(new Date(dateFrom));
    ...
    try {
        ...
        console.log(err.message + dateFrom);
    }
};
