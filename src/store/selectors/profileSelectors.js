...
export function getWeeklyPortfolioProfitAndCost(state) { if (state.currentUserData.weeklyPortfolioProfitAndCost) { return state.currentUserData.weeklyPortfolioProfitAndCost} else { return {} } }