...
import { AUTOCOMPLETE_STOCK_TICKER_WITH_SAGA } from './actions/autoComplete';
import { DEL_TICKER_WITH_SAGA } from './actions/delTicker';

import { INIT_INIT_USER_DATA_WITH_SAGA } from './actions/initUserData';
import { onAddBondsTickerWithSaga, onAddForexTickerWithSaga, onAddPifsTickerWithSaga, onAddStockTickerWithSaga, onAddTickerWithSaga, onAutoCompleteStocksTickersWithSaga, onDelTickerWithSaga } from './sagas/tickersSaga';
...
function* mySaga() {
	...
	yield takeEvery(AUTOCOMPLETE_STOCK_TICKER_WITH_SAGA, onAutoCompleteStocksTickersWithSaga);
};
