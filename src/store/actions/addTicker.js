...
export const addStockTickerWithSaga = (ticker, description, date, quantity, cost, total) => {
    return {
...
export const addPifsTickerWithSaga = (ticker, description, date, quantity, cost, total) => {
    return {
...
export const addBondsTickerWithSaga = (ticker, description, date, quantity, cost, total) => {
    return {
...
export const addForexTickerWithSaga = (ticker, description, date, quantity, cost, total) => {
    return {
